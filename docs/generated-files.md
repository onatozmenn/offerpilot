...
| `docs/images/dashboard-desktop.png` | Headless Chrome against a clean seeded Compose stack | 1440 x 1000 pixels; visual review and nonblank chart check |
| `docs/images/dashboard-mobile.png` | Headless Chrome against a clean seeded Compose stack | Mobile layout visual review and zero-overflow browser check |
